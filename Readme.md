...
| **Time Slow** | ศัตรูและ Projectile ช้าลง 87.5% เป็นเวลา 5 วินาที |

### Bome Hazard
- ระเบิด Bome จะ Spawn ทุก 20 วินาทีและกระดอนไปมาบนหน้าจอ
- ห้ามฟัน! การ Slash โดน Bome จะทำให้ **เสีย HP -30** และเกิดเอฟเฟกต์ระเบิด
...
### Easter Egg
- กดตัวละครแมวใน Menu 10 ครั้ง — Sprite จะสลับเป็น **????** 
...
5. **หลีกเลี่ยง Bomb** — อย่าฟัน Bomb ที่กระดอนอยู่ มิฉะนั้นจะเสีย HP หนัก
...
[![SweepNeko Gameplay](https://img.youtube.com/vi/kh5lyuBxuec/hqdefault.jpg)](https://youtu.be/kh5lyuBxuec)
